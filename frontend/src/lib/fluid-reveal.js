// Vendored from https://github.com/skaffa/lando-effect (GPL-3.0)
// Modified: replaced CDN Three.js import with local package
...
export default class FluidReveal {
    ...
    onMouseMove(e) {
        ...
        // Clamp to container bounds — event now fires at window level
    ...
    onResize() {
        ...
        if (this.mainUniforms.tBase.value) {
            this.mainUniforms.uScaleBase.value = this.getCoverScale(
                this.mainUniforms.tBase.value.image.width / this.mainUniforms.tBase.value.image.height,
                this.targetAspect
            );
        }
        if (this.mainUniforms.tOverlay.value) {
            this.mainUniforms.uScaleOverlay.value = this.getCoverScale(
                this.mainUniforms.tOverlay.value.image.width / this.mainUniforms.tOverlay.value.image.height,
                this.targetAspect
            );
        }
