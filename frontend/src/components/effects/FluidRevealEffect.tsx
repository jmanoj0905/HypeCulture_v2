...
function makeOverlayTexture(): string {
  ...
  for (let col = 0; col < 1024 / GRID; col++) {
    for (let row = 0; row < 1024 / GRID; row++) {
      ...
      if (r < 0.18) {
        ctx.fillStyle = `rgba(210,255,0,${0.12 + r * 0.25})`
  ...
  ctx.strokeStyle = 'rgba(210,255,0,0.55)'
  ctx.lineWidth = 1
  ...
  ctx.strokeStyle = 'rgba(178,199,58,0.25)'
  ctx.lineWidth = 1
  ...
  g.addColorStop(0, 'rgba(210,255,0,0.35)')
  g.addColorStop(0.5, 'rgba(210,255,0,0.08)')
  ...
  p.addColorStop(0, 'rgba(178,199,58,0.3)')
